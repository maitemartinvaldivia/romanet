...
const pageT = {
  ...
  el: {
    ...
    antigypsyismDescription:
      "Ο αντιτσιγγανισμός συνιστά μια ειδική μορφή ρατσισμού και διακρίσεων εις βάρος των Ρομά. Πρόκειται για ένα ιστορικά εδραιωμένο φαινόμενο, το οποίο εκδηλώνεται μέσω στερεοτύπων, κοινωνικού αποκλεισμού, άνισης μεταχείρισης και άλλων μορφών διάκρισης, τόσο στο παρελθόν όσο και στη σύγχρονη εποχή.",
    historicalRoots: "Ιστορικές ρίζες",
    historicalItems: [
      "Μακρά ιστορία διώξεων, υποδούλωσης και γενοκτονιών",
      "Συστηματικός κοινωνικός και οικονομικός αποκλεισμός",
      "Πολιτικές πρακτικές αφομοίωσης και όχι ένταξης",
      "Διαχρονικές διακρίσεις στη στέγαση, την απασχόληση και την εκπαίδευση",
    ],
    modernManifestations: "Σύγχρονες μορφές εκδήλωσης",
    modernItems: [
      "Αρνητικά στερεότυπα στα μέσα ενημέρωσης και στη λαϊκή κουλτούρα",
      "Διακρίσεις στην πρόσβαση σε υπηρεσίες",
      "Ρητορική μίσους στα μέσα κοινωνικής δικτύωσης και στις διαδικτυακές πλατφόρμες",
    ...
    checklistItems: [
      "Χρήση υποτιμητικών όρων και υβριστικών χαρακτηρισμών",
      "Γενικεύσεις και αρνητικές αναπαραστάσεις ολόκληρων ομάδων",
      "Διάδοση θεωριών συνωμοσίας",
      "Χρήση απανθρωποποιητικής γλώσσας ή εικόνων",
      "Προτροπές σε βία, αποκλεισμό ή διακρίσεις",
      "«Αστεία» που αναπαράγουν στερεότυπα ή υποτιμούν ομάδες ανθρώπων",
    ],
    rightsTitle: "Τα δικαιώματά σας",
    rightsIntro: "Κάθε άνθρωπος έχει το δικαίωμα:",
    rightsItems: [
      "Να ζει χωρίς διακρίσεις",
      "Να καταγγέλλει περιστατικά ρητορικής μίσους και εγκλημάτων μίσους",
      "Να έχει πρόσβαση στη δικαιοσύνη και σε κατάλληλες υπηρεσίες υποστήριξης",
      "Να απολαμβάνει τον σεβασμό της αξιοπρέπειάς του",
      "Να συμμετέχει ισότιμα και πλήρως στην κοινωνική ζωή",
    ],
